...
user_services_post_args.add_argument("type", type=str, help="Type is missing")
user_services_post_args.add_argument("question_paper_attempts", type=str, help="Json string for question paper attempts is missing")
...
question_paper_services_post_args.add_argument("duration", type=str, help="Duration is missing")
